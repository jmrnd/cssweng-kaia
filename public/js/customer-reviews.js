...
const starIconHalf =    `<svg class="star-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-half" viewBox="0 0 16 16">
                        ...
                        function showReviewImages(review, reviewId) {
                            ...
                            const prevButton = review.querySelector(`.review-previous-image-button[data-review-id="${reviewId}"]`);
                            const nextButton = review.querySelector(`.review-next-image-button[data-review-id="${reviewId}"]`);
                        ...
                        function renderUserRatings(review) {
                            ...
                            const userRating = parseFloat(userRatingElement.getAttribute('data-userrating'));
